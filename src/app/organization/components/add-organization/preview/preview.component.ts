...
export class PreviewComponent implements OnInit {
  ...
  constructor(private moduleService : ModuleService, private addOrganizationService: AddOrganizationService, private vcrf: ViewContainerRef, private cfr: ComponentFactoryResolver) { }
    ...
    Swal.fire({
      ...
      .subscribe((res) => {
        ...
        if (this.organizationType == "Seller") {
          ...
          obj.phone_number = this.masterUserDetails.phoneNumber;
          if (this.settingsDetails.authType == "password") {
            obj.password = this.settingsDetails.password;
          }
          ...
          obj.middle_name = this.masterUserDetails.middleName;
          obj.phone_number = this.masterUserDetails.phoneNumber;
          if (this.settingsDetails.passwordSetting) {
            obj.password = this.settingsDetails.password;
          }
